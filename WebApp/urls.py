...
urlpatterns = [
    ...
    path('estate/<int:estate_id>/notfinished', views.admin_estate_notfinished, name='estate_notfinished'),
    path('estate/<int:estate_id>/<int:item_id>/finish', views.estate_item_finished, name='estate_item_finished'),
